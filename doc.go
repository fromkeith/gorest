...
//      sayHelloXml gorest.EndPoint `method:"GET" path:"/hello/xml/{name:string}" output:"string" produces:"application/xml"`
//	}
...
//	    return "Hello " + name
//	}
//  func(serv HelloService) SayHelloXml(name string) string{
//      return serv.SayHello(name)
//  }
package gorest
